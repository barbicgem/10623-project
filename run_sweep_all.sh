#!/usr/bin/env bash
# LoRA rank sweep on both arithmetic (deepmind, bytes-fixed) and eleuther_arithmetic.
# Usage: bash run_sweep_all.sh
...
echo "========================================"
echo "Full sweep complete. Checkpoints in ${OUTPUT_BASE}/"
echo "========================================"
